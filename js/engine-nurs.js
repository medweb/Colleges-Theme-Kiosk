...
jQuery( document ).ready(function($) {
    ...
    const autoscroll_to_pages       = [
        '/nursing-kiosk/',
        '/nursing-kiosk/events/',
        '/nursing-kiosk/social/'
    ];  // after timeout, autoscroll these pages (in the order specified)
    const autoscroll_within_pages   = ['/nursing-kiosk/']; // if we are on these pages, it will first autoscroll inner elements until the end, then go to the next autoscroll page.
